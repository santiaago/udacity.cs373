...
def run(param1, param2, param3):
    ...
    #I = integral
    #D = differential
    crosstrack_error_last = myrobot.y
    sum_crosstrack_error = 0.0
    for i in range(N):
        crosstrack_error = myrobot.y
        sum_crosstrack_error += crosstrack_error
        steer = -param1 * crosstrack_error - param2*(crosstrack_error - crosstrack_error_last) - param3*sum_crosstrack_error
        crosstrack_error_last = crosstrack_error
